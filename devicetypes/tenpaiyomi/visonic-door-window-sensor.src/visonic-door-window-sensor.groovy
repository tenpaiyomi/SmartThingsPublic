...
metadata {
	definition (name: "Visonic Door/Window Sensor", namespace: "tenpaiyomi", author: "Eric Musgrove") {
		capability "Battery"
		...
		fingerprint inClusters: "0000,0001,0003,0402,0500,0020,0B05", outClusters: "0019", manufacturer: "Visonic", model: "MCT-350 SMA"        
	}
